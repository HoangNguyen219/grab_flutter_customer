...
import 'package:grab_customer_app/views/auth/widget/otp_page_top_body_widget.dart';
import 'package:grab_customer_app/views/auth/widget/textfield_widget.dart';
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          String otp = code1.text +
                              ...
                              code5.text +
                              code6.text;
                          authController.verifyOtp(otp, context);
                        },
                        style: ButtonStyle(
                          foregroundColor:
