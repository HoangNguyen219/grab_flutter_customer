...
PredictionsList predictionsFromJson(String str) => PredictionsList.fromJson(json.decode(str));
...
class StructuredFormatting {
  ...
  factory StructuredFormatting.fromJson(Map<String, dynamic> json) => StructuredFormatting(
        ...
        mainTextMatchedSubstrings:
            List<MatchedSubstring>.from(json["main_text_matched_substrings"].map((x) => MatchedSubstring.fromJson(x))),
